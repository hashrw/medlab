...
@php
    // Si viene tratamiento y tiene diagnostico_id => es inferido (no editable en cabecera)
...
<div class="p-6 bg-white border-t border-gray-200">
    ...
    @if($esInferido)
        <div class="mb-4 rounded-md border border-yellow-200 bg-yellow-50 p-4 text-sm text-yellow-900">
            Este tratamiento es inferido por el motor. La cabecera es de solo lectura. La gestión clínica se realiza en las líneas.
        </div>
    @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
            ...
            {{-- Paciente (FIJO siempre en edit / y en inferidos) --}}
            <div>
                ...
                @if($pacienteFijo)
                    ...
                    <div class="flex items-center gap-3 bg-gray-50 border border-gray-300 rounded-md px-3 py-2 shadow-sm">
                        ...
                        <input type="text"
                               ...
                               disabled
                               value="{{ $pacienteFijo->usuarioAcceso->name ?? 'Paciente sin usuario' }} ({{ $pacienteFijo->nuhsa }})">
                    </div>
                @else
                    {{-- Solo en create/manual permitimos seleccionar paciente --}}
                    <div class="flex items-center gap-3 bg-gray-50 border border-gray-300 rounded-md px-3 py-2 shadow-sm">
                        <i class="fas fa-user-injured text-blue-600"></i>
