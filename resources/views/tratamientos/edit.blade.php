                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-end gap-2">
                                        {{-- Cerrar línea (PATCH) --}}
                                        <form method="POST" action="{{ route('tratamientos.cerrarLinea', $tratamiento->id) }}" class="flex items-center gap-2">
                                            @csrf
                                            @method('PATCH')
