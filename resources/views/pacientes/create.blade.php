                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('pacientes.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nuhsa" class="block mt-1 w-full" type="text" name="nuhsa"
                                :value="old('nuhsa')" required />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="peso" class="block mt-1 w-full" type="number" step="0.1" name="peso"
                                :value="old('peso')" required />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="altura" :value="__('Altura (cm)')" />
                            <x-text-input id="altura" class="block mt-1 w-full" type="number" step="1" name="altura"
