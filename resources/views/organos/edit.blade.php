    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li>
                    <span class="text-gray-500" aria-current="page">Editar {{ $organo->nombre }}</span>
                </li>
            </ol>
        </nav>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-6 bg-blue-800 text-white">
                    <h3 class="text-lg font-semibold">Editar zona de afectación</h3>
                </div>
                    ...
                    <form method="POST" action="{{ route('organos.update', $organo->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nombre" class="block mt-1 w-full"
                                          ...
                                          :value="$organo->nombre" required autofocus />
                        </div>
