                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="POST" action="{{ route('medicamentos.update', $medicamento->id) }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="nombre" class="block mt-1 w-full" type="text" name="nombre" :value="$medicamento->nombre" required autofocus />
                            </div>

                                <div>
                                    <x-input-label for="miligramos" :value="__('Dosis (mg.)')" />

                                    <x-text-input id="miligramos" class="block mt-1 w-full" type="number" min="0" step="50" name="miligramos" :value="$medicamento->miligramos" required />
                                </div>
