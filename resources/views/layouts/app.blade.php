...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            position: sticky;
            top: 0;
            height: calc(100vh - 64px); /* Restar altura de la barra de navegación */
            overflow-y: auto;
            z-index: 30;
        }
...
<body class="font-sans antialiased bg-gray-50">
    <div class="app-wrapper">
        ...
        <div class="main-container">
            ...
            <aside class="sidebar">
                <nav class="py-4">
                    <div class="mb-6 px-4">
                        <h3 class="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-4">MENÚ PRINCIPAL</h3>
                        <ul class="space-y-1">
                            <li>
                                <a href="{{ route('dashboard.medico') }}" class="menu-item {{ request()->routeIs('dashboard.medico') ? 'active' : '' }}">
                                    <i class="fas fa-home menu-icon"></i>
                                    <span>Inicio</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('pacientes.index') }}" class="menu-item {{ request()->routeIs('pacientes.*') ? 'active' : '' }}">
                            ...
                            <li>
                                <a href="{{ route('tratamientos.index') }}" class="menu-item {{ request()->routeIs('tratamientos.*') ? 'active' : '' }}">
                                    <i class="fas fa-pills menu-icon"></i>
                                    <span>Módulo de tratamientos</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('medicamentos.index') }}" class="menu-item {{ request()->routeIs('medicamentos.*') ? 'active' : '' }}">
                                    <i class="fas fa-prescription-bottle-alt menu-icon"></i>
                                    <span>Módulo de medicamentos</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('citas.index') }}" class="menu-item {{ request()->routeIs('citas.*') ? 'active' : '' }}">
    ...
    <!-- Botón para móvil -->
    <button id="menu-toggle" class="md:hidden fixed bottom-6 right-6 bg-blue-500 text-white p-3 rounded-full shadow-lg z-50">
