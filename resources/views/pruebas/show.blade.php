        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-6 bg-blue-800 text-white">
                    <h3 class="text-lg font-semibold">Información de la prueba clínica</h3>
                </div>
                ...
                <div class="p-6 bg-white border-t border-gray-200">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="tipo_prueba" class="block mt-1 w-full"
                                      type="text" name="tipo_prueba" disabled
                                      :value="$prueba->tipo_prueba" required />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="fecha" :value="__('Fecha de la prueba')" />
                        <x-text-input id="fecha" class="block mt-1 w-full"
                                      type="date" name="fecha" disabled
                                      :value="$prueba->fecha" required />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="resultado" :value="__('Resultado')" />
                        <x-text-input id="resultado" class="block mt-1 w-full"
                                      type="text" name="resultado" disabled
                                      :value="$prueba->resultado" required />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="comentario" :value="__('Comentario')" />
                        <x-text-input id="comentario" class="block mt-1 w-full"
                                      type="text" name="comentario" disabled
