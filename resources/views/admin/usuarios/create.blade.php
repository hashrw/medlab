        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white border rounded-lg p-6 shadow-sm">
                ...
                <p class="text-sm text-gray-600 mt-1">
                    Seleccione el tipo de usuario que desea crear.
                </p>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="{{ route('admin.usuarios.createPaciente') }}"
                        ...
                        <div class="text-sm text-gray-600 mt-2">
                            Crea usuario paciente y asigna médico.
                        </div>
                    </a>

                    <a href="{{ route('admin.usuarios.createMedico') }}" class="border rounded-lg p-5 hover:bg-gray-50">
                        ...
                        <div class="text-sm text-gray-600 mt-2">
                            Crea usuario con perfil médico.
                        </div>
                    </a>
                </div>
            </div>
